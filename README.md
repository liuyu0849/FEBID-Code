...
| **火山口形貌条件**      | $$\tilde{\tau} > 1 + 2\gamma^{3/2}$$                         | 电子束诱导反应速率 > 前驱体扩散补充速率，导致火山口形貌。速率差异越大，火山口越显著                    |
| **高斯→火山口转变时间** | $t_{\text{transition}} = \frac{FWHM^2}{D}$ | **扩散特征时间**<br>与γ无关（火山口形貌下）<br>**物理意义**：前驱体扩散穿越束斑所需时间，此时最高处不再是中心 |
| **火山口半径**          | $r_{crater} \approx \frac{FWHM}{2.355} \sqrt{\ln\left(\frac{\tilde{\tau}}{1 + 2\gamma^{3/2}}\right)}$ | **条件**：当 \gamma 增大，半径减小，当\tilde{\tau}增大，半径增大 |
